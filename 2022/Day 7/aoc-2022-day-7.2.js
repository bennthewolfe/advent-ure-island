...
70_000_000 = Total Space
30_000_000 = Needed Free Space

40_208_860 = Used Space

208_860 = Space to cut

*/

const toCut = 208_860;

let cutOptions = Object.values(dirs).filter(dir => dir[2] >= toCut);

let cutOptionsArray = cutOptions.map((el,index) => {
    return el[2];
});

cutOptionsArray = cutOptionsArray.sort((a,b) => a-b);

console.table(cutOptionsArray);